...
func main() {
	...
	newRestaurant := Restaurant{Name: "Phở bò", Address: "Trường chinh", PhoneNumber: 123456}
	...
	db.Where("phone_number=? ", 123456).Find(&restaurants)
	db.Where("address=? ", "Trường chinh").Find(&restaurants)
